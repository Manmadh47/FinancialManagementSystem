...
export class SummaryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['ProjectId','Revenue','GPM','Ebitda'];
  ...
  overallSummary(){
    for(let project in this.projectValues){
      ...
      this.summaryService.totalSummary=this.list;//need to clear
      this.listData=new MatTableDataSource( this.summaryService.totalSummary);
